...
<div  id="game-detail-info" class="mobile_full">
	...
	<article class="post-2816 page type-page status-publish hentry instock">
					...
					<tr>
						<td>
							...
							<form action="<?php echo home_url('/');?>buy" method="post" name="order_account_form">
								...
								<input id="extra_species" name="extra_species" type="hidden" value="<?php echo 'account_wow';?>">
		...
		<table border="0" class="tableFeatures" summary="Comparison">
			
			<tbody>
				<tr>
					<th colspan="2"><h4 class="blueHeading">Compare Now with other character</h4></th>
				</tr>
				<tr>
					<td class="name">
				<a href="#" class="comparision" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'ScCH+NStrtCMsZQH5EQV3Ek/xP0utugYcVv1awdwYIk='); f.appendChild(s);f.submit();return false;">COMPARISON</a>
			  </td>
				</tr>
			</tbody>
		</table>
		<table border="0" class="tableFeatures extras" summary="Purchasable Extras">
			<tbody>
				<tr>
					<th colspan="2"><h4 class="blueHeading">Purchasable Extras</h4></th>
					
				</tr>
				<tr>
					<td class="name">
						<p></p><div class="wyswyg"><font size="1" color="#008000">Paid Character Transfer + Character Rename (We guarantee that every transfer makes with us using our prepaid credit card will be safe and handled with the highest security)</font></div><p></p>
					</td>
					<td class="price">
						<span>USD</span><strong>$49.00</strong>
					</td>
				</tr>
				<tr>
					<td class="name">
						<p></p><div class="wyswyg"><font size="1" color="#6600FF">You can request for a Character Change for one time within the first 7 days after your purchase. 70% of the amount paid will be returned to you in Store-Credit for your Character Change purpose.</font></div><p></p>
					</td>
					<td class="price">
						<span>USD</span><strong>$0.00</strong>
					</td>
				</tr>
				<tr>
					<td class="name">
						<p></p><div class="wyswyg"><font face="arial,helvetica,sans-serif" size="1" color="#ff6600">60 Days Game Time Card (Original Price: $29.99)</font></div><p></p>
					</td>
					<td class="price">
						<span>USD</span><strong>$28.99</strong>
					</td>
				</tr>
				<tr>
					<td class="name">
						<p></p><div class="wyswyg"><font face="arial,helvetica,sans-serif" size="1" color="#000000"><font color="#ff0000">WOW Mists of Pandaria Upgrade</font> - Requires full version of Cataclysm Account prior to the&nbsp;MOP Upgrade (Original Price $39.99)</font></div><p></p>
					</td>
					<td class="price">
						<span>USD</span><strong>$38.99</strong>
					</td>
				</tr>
				<tr>
					<td class="name">
						<p></p><div class="wyswyg"><font face="arial,helvetica,sans-serif"><font size="2" color="#ff0000"><font size="1">Battle.net Name Change Service (New)</font></font></font></div><p></p>
					</td>
					<td class="price">
						<span>USD</span><strong>$149.00</strong>
					</td>
				</tr>
			</tbody>
		</table>
