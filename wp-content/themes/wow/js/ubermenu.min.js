...
jQuery(document).ready(function(b) {
    ...
    uberMenuSettings.iOScloseButton = "on" == uberMenuSettings.iOScloseButton ? !0: !1;
    uberMenuSettings.loadGoogleMaps = 
    "on" == uberMenuSettings.loadGoogleMaps ? !0: !1;
    ...
    uberMenuSettings.androidClick && c.match(/(android)/) && (uberMenuSettings.trigger = "click");
    window.navigator.msMaxTouchPoints && (uberMenuSettings.trigger = "click");
    c.match(/(iphone|ipod|ipad)/) && (uberMenuSettings.trigger = "hover");
    c = b("#megaMenu");
    if (0 != c.size()) {
        c.uberMenu(uberMenuSettings);
        c.data("uberMenu");
        "undefined" !== typeof google && ("undefined" !== typeof google.maps && "undefined" !== typeof google.maps.LatLng) && b(".spark-map-canvas").each(function() {
            var c = b(this),
            a = c.attr("data-zoom") ? parseInt(c.attr("data-zoom")) : 8,
            m = c.attr("data-lat") ? new google.maps.LatLng(c.attr("data-lat"), c.attr("data-lng")) : new google.maps.LatLng(40.7143528, -74.0059731),
            f = new google.maps.Map(this, {
                zoom: a,
                mapTypeId: google.maps.MapTypeId.ROADMAP,
                center: m
            });
            c.attr("data-address") ? (new google.maps.Geocoder).geocode({
                address: c.attr("data-address")
            },
            function(b, a) {
                a == google.maps.GeocoderStatus.OK && (f.setCenter(b[0].geometry.location), m = b[0].geometry.location, new google.maps.Marker({
                    map: f,
                    position: b[0].geometry.location,
                    title: c.attr("data-mapTitle")
                }))
 ...
 (function(b) {
    b.uberMenu = function(c, k) {
            ...
            e.each(function() {
                ...
                case "horizontal":
                    if (b(this).hasClass("ss-nav-menu-mega-alignCenter") && !b(this).hasClass("ss-nav-menu-mega-fullWidth")) {
                        var l = b(this).outerWidth(),
                        f = e.outerWidth(),
                        l = b(this).offset().left + 
                        l / 2 - (a.menuEdge + f / 2),
                        l = 0 < l ? l: 0;
                        l + f > g && (l = g - f);
                        e.css({
                ...
                case "vertical":
                    if (b(this).hasClass("ss-nav-menu-mega-alignCenter")) {
                        var l = b(this).outerHeight(),
                        f = e.outerHeight(),
                        l = b(this).offset().top + l / 2 - (a.menuEdge + f / 2),
                        m = 0 < l ? l: 0;
                        m + f > c && (l = c - f);
                        e.css({
                            top: m
        ...
        f = function(e) {
            var d = b(e);
            p(d);
            d.addClass("megaHover wpmega-expanded");
            e = d.find("ul.sub-menu-1");
            switch (a.settings.transition) {
            case "slide":
                e.stop(!0, !0).slideDown(a.settings.speed, "swing", 
                function() {
                    d.trigger("ubermenuopen")
                });
                break;
            case "fade":
                e.stop(!0, !0).fadeIn(a.settings.speed, "swing", 
                function() {
                    d.trigger("ubermenuopen")
                });
                break;
        ...
        n = function(e) {
            var d = b(e);
            if (d.has("ul.sub-menu")) {
                d.hasClass("ss-nav-menu-reg") ? p(d) : d.siblings().each(function() {
                    h(this, !0)
                });
                d.addClass("megaHover");
                var g = d.find("> ul.sub-menu");
                switch (a.settings.transition) {
                case "slide":
                    g.stop(!0, !0).slideDown(a.settings.speed, "swing", 
                    function() {
                        d.trigger("ubermenuopen");
                    ...
                    break;
                    case "fade":
                    g.stop(!0, !0).fadeIn(a.settings.speed, "swing", 
                    function() {
                        d.trigger("ubermenuopen")
                    });
                    break;
        ...
        h = function(e, d) {
            var g = b(e),
            c = g.find("> ul.sub-menu");
            if (d) c.hide(),
            g.removeClass("megaHover").removeClass("wpmega-expanded");
            else if (0 < c.size()) switch (a.settings.transition) {
            case "slide":
                c.stop(!0, !0).slideUp(a.settings.speed, 
                function() {
                    g.removeClass("megaHover").removeClass("wpmega-expanded");
        ...
        p = function(b) {
            var d = a.$megaMenu.find("> ul.megaMenu > li");
            null != b && (d = d.not(b));
            d.removeClass("megaHover").removeClass("wpmega-expanded").find("> ul.sub-menu").hide()
        };
        ...
        a.redrawSubmenus = function() {
            ...
            a.settings.fullWidthSubs || m(b, !0)
        }; (function() {
            a.settings = b.extend({},
            q, k);
            a.el = c;
            ...
            a.settings.fullWidthSubs ? e.find("> ul.sub-menu-1").hide() : (m(e, !0), b(window).resize(function() {
                m(e, !1)
            }));
            ...
            case "click":
                e.find("> a, > span.um-anchoremulator").click(function(a) {
                    ...
                    a.preventDefault();
                    c.hasClass("wpmega-expanded") ? (c.removeClass("wpmega-expanded"), h(c.get(0), !1)) : (c.addClass("wpmega-expanded"), f(c.get(0)))
                });
            ...
            var d = 
            a.$megaMenu.find("ul.megaMenu > li.ss-nav-menu-reg.mega-with-sub, li.ss-nav-menu-reg li.megaReg-with-sub");
            d.find("ul.sub-menu").hide();
            switch (a.settings.trigger) {
            case "click":
                d.find("> a, > span.um-anchoremulator").click(function(a) {
                    var c = b(this).parent("li");
                    a.preventDefault();
                    a.stopPropagation();
                    c.hasClass("wpmega-expanded") ? (c.removeClass("wpmega-expanded"), h(c.get(0))) : (c.addClass("wpmega-expanded"), n(c.get(0)))
                });
                break;
            case "hoverIntent":
                d.hoverIntent({
                    ...
                    out: function(a) {
                        "object" === 
                        typeof a && b(a.fromElement).is("#megaMenu form, #megaMenu input, #megaMenu select, #megaMenu textarea, #megaMenu label") || h(this, !1)
                    },
                    timeout: a.settings.hoverTimeout,
                    interval: a.settings.hoverInterval,
                    sensitivity: 2
            ...
            d = navigator.userAgent.toLowerCase().match(/(iphone|ipod|ipad)/);
            uberMenuSettings.iOScloseButton && (jQuery.uber_mobile || d) && (b('<span class="uber-close">&times;</span>').appendTo("#megaMenu li.mega-with-sub > a, #megaMenu li.mega-with-sub > span.um-anchoremulator"), 
            a.$megaMenu.on("click", ".uber-close", 
            function(a) {
                a.preventDefault();
                ...
                a.preventDefault();
                b(this).find(".uber-close").html("&times;").attr("data-uber-status", "open").show()
            },
            function(a) {
                a.preventDefault();
    ...
    b.fn.uberMenu = function(c) {
        return this.each(function() {
            if (void 0 == b(this).data("uberMenu")) {
                var k = new b.uberMenu(this, c);
                b(this).data("uberMenu", k)
            }
        })
    }
})(jQuery);
